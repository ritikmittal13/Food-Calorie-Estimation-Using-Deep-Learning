...
#density - gram / cm^3
density_dict = {1: 0.609, 2: 0.94, 3: 0.641,
                4: 0.641, 5: 0.513, 6: 0.482, 7: 0.481}
# kcal
...
def calories(result, img):
    # "C:/Users/M Sc-2/Desktop/dataset/FooD/"+str(j)+"_"+str(i)+".jpg"
    img_path = img
    fruit_areas, final_f, areaod, skin_areas, fruit_contours, pix_cm = getAreaOfFood(
        img_path)
